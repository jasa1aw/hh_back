...
const spicializationTypesUpdated = spicializationTypes.map(item => {
  return {
    name: item["name"]
  }
})
...
spicializationTypes.forEach((item, index) => {
...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('SpecializationTypes', spicializationTypesUpdated, {});
